  <aside class="sidebar">
    ...
    <ul class="sidebar-nav">
      ...
      <li><a href="/employe/form-conge"><i class="bi bi-plus-circle"></i> Nouvelle demande</a></li>
      <li>
    ...
    <div class="sidebar-user">
      <div class="s-user-row">
        ...
        <a href="/login" style="margin-left:auto;color:rgba(255,255,255,.25);font-size:1.1rem" title="Déconnexion"><i class="bi bi-box-arrow-right"></i></a>
      </div>
    </div>
  </aside>